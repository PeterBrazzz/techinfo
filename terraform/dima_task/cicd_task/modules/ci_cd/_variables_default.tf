variable "application" {
  ...
  validation {
    ...
    error_message = "Application name must not be null."
  }
}
...
variable "code_pipeline_output_artifact_format" {
  type        = string
  description = "Output artifact format for BUILD step."
  default     = "CODE_ZIP"
}
...
variable "code_build_app_environment_vars" {
  type = list(
    object({
      name  = string
      value = string
  ...
  description = "A list of plaintext env variables is set to app during CodeBuild."
  default     = []
}

variable "code_build_app_environment_vars_ssm" {
  type = list(
    object({
      name = string
      arn  = string
  ...
  description = "A list of env variables from ssm parameters is set to app during CodeBuild."
  default     = []
}

variable "code_build_app_environment_vars_secrets_manager" {
  type = list(
    object({
      keys = list(string)
      arn  = string
  ...
  description = "A list of env variables from secrets manager is set to app during CodeBuild."
  default     = []
}
